    ...
    <>
      ...
      <div className="bg-[#0A0D14] text-white text-[11px] py-2 px-4 sm:px-6 border-b border-white/10">
        <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto flex items-center justify-between flex-wrap gap-x-4 gap-y-1.5">
          ...
          {/* Social Channels: WhatsApp, TikTok, Email */}
          <div className="flex items-center gap-3 sm:gap-5 ml-auto flex-wrap">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 font-bold text-white bg-[#25D366] hover:bg-[#20BD5A] px-2.5 py-0.5 rounded-full shadow-xs transition-transform active:scale-95"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 font-semibold text-gray-200 hover:text-white bg-white/10 hover:bg-white/20 px-2 py-0.5 rounded-full transition-colors"
            >
              <svg className="w-3.5 h-3.5 text-[#25F4EE] fill-current" viewBox="0 0 24 24">
                <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.24 8.24 0 004.84 1.56V6.78a4.85 4.85 0 01-1.07-.09z"/>
              </svg>
              <span>TikTok: @smartechkenya</span>
            </a>

            {/* Email */}
            <a
              href="mailto:smartechkenya01@gmail.com"
              className="hidden sm:inline-flex items-center gap-1.5 font-semibold text-gray-300 hover:text-white transition-colors"
            >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden" onClick={() => setMobileOpen(false)}>
          ...
          <nav className="absolute top-[calc(62px+36px)] inset-x-0 bg-white border-b border-gray-100 shadow-2xl
            ...
            {/* Direct Connect in Mobile Drawer: WhatsApp, TikTok, Email */}
            <div className="p-4 space-y-2.5 bg-gray-50 border-t border-gray-100">
              ...
              <a href="https://wa.me/254746722417?text=Hi%20Smartech%20Kenya%2C%20I%20want%20to%20order"
                target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-white text-sm font-bold shadow-sm bg-[#25D366] hover:bg-[#20BD5A] transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
                <span>WhatsApp: +254 746 722 417</span>
              ...
              <a href="https://tiktok.com/@smartechkenya"
                target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-white text-sm font-bold bg-black hover:bg-gray-900 transition-all border border-white/10">
              ...
              <a href="mailto:smartechkenya01@gmail.com"
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-xs font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-100 transition-all">
                <svg className="w-4 h-4 text-[#F97316]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <span>Email: smartechkenya01@gmail.com</span>
              </a>
