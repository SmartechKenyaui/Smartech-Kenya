...
const SOCIAL = [
  {
    ...
    label: 'WhatsApp: +254 746 722 417',
  ...
  },
  {
    ...
    label: 'TikTok: @smartechkenya',
    color: 'bg-black hover:bg-neutral-800 text-white border border-white/20',
    icon: (
      <svg className="w-4 h-4 text-[#25F4EE] fill-current" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    label: 'Email: smartechkenya01@gmail.com',
            ...
            <div className="flex flex-wrap gap-3 mt-6 sm:mt-8">
              {SOCIAL.map(s => (
                <a
                  ...
                  className={`inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold transition-all hover:scale-102 active:scale-98 shadow-sm ${s.color}`}
                >
                  {s.icon}
                  <span>{s.label}</span>
                </a>
